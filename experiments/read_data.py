...
def get_world_config(num_goals, mode, idx):
...
def get_image_path(num_goals, mode, idx):
    path = f"../data/colored_box_pictures/obs-2/{num_goals}_goals/{num_goals}_goals_{mode}_set_samples/{num_goals}_goals_{mode}_set_samples_{idx+1}.png"
    return path
